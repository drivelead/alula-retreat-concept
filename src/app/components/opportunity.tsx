...
export default function Opportunity({}: Props) {
  ...
  return (
    <AnimatedSection
      id="opportunity"
      className="bg-neutral-900 text-neutral-200 relative flex flex-col">
        ...
        <div className="grid grid-cols-2 w-full gap-8 p-8">
          <div className="col-span-2">
            <Image
              ...
              width={1024}
              height={768}
              className="anim w-full h-full object-cover border-20 border-white shadow-2xl rotate-1"
          ...
          <div>
            <Image
              ...
              width={1024}
              height={768}
              className="anim w-full h-full object-cover border-20 border-white shadow-2xl -rotate-2"
              alt="hegra-location-photo"
            />
          </div>
          <div className="h-full">
            <Image
              ...
              width={1024}
              height={768}
              className="anim w-full h-full object-cover border-20 border-white shadow-2xl"
              alt="hegra-location-photo"
            />
          </div>
        </div>
